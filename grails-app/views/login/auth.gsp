...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Triclinio</b></a>
    </div>
    <!-- /.login-logo -->
    ...
    <g:if test='${flash.message}'>
        ...
        <form action="${postUrl ?: '/login/authenticate'}" method="POST" id="loginForm">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Nombre Usuario" name="${usernameParameter ?: 'username'}" id="username">
        ...
        %{--<a href="#"><g:message code="triclinio.login.olvidoContrasena"/></a><br>--}%
