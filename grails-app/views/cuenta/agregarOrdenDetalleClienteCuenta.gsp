...
<section class="content">
    ...
    <input type="hidden" value="${clienteCuenta.id}" name="clienteCuentaId" id="clienteCuentaId" class="form-control">
...
<!--    TABLA ITEMS AGREGADOS-->
    <div class="box">
        ...
        <div class="box-body no-padding">
            ...
            <button id="guardarOrden" name="guardarOrden" style="margin-top: 2%" type="summit" class="btn btn-success btn-block">Guardar</button>
        </div>
    </div>
