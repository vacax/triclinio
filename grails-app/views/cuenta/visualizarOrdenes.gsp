...
<section class="content">
                    ...
                    <form role="form">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input id="nombreCliente" disabled="disableda" value="${clienteCuenta.nombre}" name="nombreCliente"  type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Comentario: </label>
                                <input id="comentario" value="${clienteCuenta.comentario}" name="comentario" class="form-control" rows="3">${clienteCuenta.comentario}</input>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="box">
        ...
        <div class="box-body no-padding">
            ...
            <button class="btn btn-danger btn-block"  onclick="window.history.back();" >Volver Atras</button>
