                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <g:each in="${mesasOcupadas}" var="mesa">
                                <g:if test="${mesa.estadoMesa.codigo == com.triclinio.domains.restaurante.EstadoMesa.getOCUPADA()}">
                                    <tr>
                                        ...
                                        <td>
                                            <g:link action="habilitarMesa" controller="mesa"  params="[idMesa: mesa.id, ventanaNombre:'desocupar']"><button type="button" class="btn btn-block btn-success">Desocupar</button></g:link>
                                        </td>
                                    </tr>
                                </g:if>
                            </g:each>
