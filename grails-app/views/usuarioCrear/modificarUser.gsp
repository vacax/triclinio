    ...
    <g:form action="nuevoUsuario">
        <div class="box-body">
            ...
            %{--<div style="margin-bottom:10%" class="form-group">--}%
                ...
                %{--<div class="col-sm-10">--}%
                    %{--<input value="${usuario.p}" style="border: 1px solid cornflowerblue;" type="password" name="passwordUser" class="form-control" id="inputPassword3" placeholder="Password">--}%
                %{--</div>--}%
            %{--</div>--}%
            <div style="margin-top:5%" class="form-group">
                <label  class="col-sm-2 control-label">Nombre</label>
                <div class="col-sm-10">
                    <input value="${usuario.nombre}" style="border: 1px solid cornflowerblue;" type="text" name="nombreUser" class="form-control" id="inputName" placeholder="nombre">
                </div>
            </div>
